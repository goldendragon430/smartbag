                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        ...
                        await ApiRecord.createDoc(currentUserReference!)
                            .set(apiCreateData);
                        setState(() {
                          FFAppState().connected = widget.connected!;
                          FFAppState().apiKey = _model.textController1.text;
                          FFAppState().secretKey = _model.textController2.text;
                        });
